...
Sidebar.prototype.addGeneralPalette = function(expand)
{
	...
	var fns = [
		this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;html=1;fillColor=#727ca3;', 120, 60, '<font style="font-size: 14px; color: #fafafa;"><b>Entity</b></font> ', 'Entity', null, null, 'Entity that can have attributes'),
		...
		this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;', 100, 40, '', 'Attribute', null, null, 'An attribute for entities'),
		...
		this.createVertexTemplateEntry('rhombus;whiteSpace=wrap;html=1;fillColor=#727ca3;', 100, 100, '<font style="font-size: 14px; color: #fafafa;"><b>Association</b></font>', 'Association', null, null, 'Association relationship between entities'),


		this.createVertexTemplateEntry(
			'rhombus;whiteSpace=wrap;html=1;fillColor=#ABD5FF;',
			 70, 
			 70, 
			mxConstants.IS_A_VALUE,
			 '"IS A" relationship', 
			 null, 
			 null, 
			 'Specialization(subclass) relationship between entities'),
...
Sidebar.prototype.addUmlPalette = function(expand)
{
	...
	var fns = [
		...
		this.createVertexTemplateEntry('verticalAlign=top;align=left;overflow=fill;html=1;',180, 90,
			...
			'<tr><td>uniqueId</td></tr><tr><td>' +
			'foreignKey</td></tr><tr><td>fieldname</td></tr></table>', 'Entity', null, null, 'er entity table'),
		// this.addEntry(dt + 'object instance', function()
		// {
...
Sidebar.prototype.createVertexTemplate = function(style, width, height, value, title, showLabel, showTitle, allowCellsInserted)
{
	...
	cells[0].vertex = true;
	// TODO: Add an argument for the type of the created cell
